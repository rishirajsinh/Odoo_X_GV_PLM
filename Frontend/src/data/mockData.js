...
export const products = [
  {
    ...
    status: 'Active',
    category: 'Mechanical',
    description: 'High-pressure hydraulic pump for industrial applications. Max pressure 350 bar.',
    price: 2450.00,
    weight: '18.5 kg',
  ...
  },
  {
    ...
    description: 'Programmable ECU for motor control systems. Supports CAN bus and Ethernet.',
    price: 890.00,
    weight: '0.45 kg',
  ...
  },
  {
    ...
    status: 'Active',
    category: 'Mechanical',
    description: 'High-ratio planetary gear box for robotics applications. 100:1 reduction ratio.',
    price: 1200.00,
    weight: '5.2 kg',
  ...
  {
    id: 'p4',
    name: 'Thermal Sensor Module',
    sku: 'TSM-2024-012',
    version: '1.1',
    status: 'Active',
    category: 'Electronics',
    description: 'Multi-point thermal sensor for industrial monitoring. -40°C to +250°C range.',
    price: 320.00,
    weight: '0.12 kg',
    material: 'Ceramic / Platinum RTD',
  ...
  {
    id: 'p5',
    name: 'Linear Actuator v1',
    sku: 'LAV-2023-002',
    version: '2.3',
    status: 'Archived',
    category: 'Mechanical',
    description: 'Electric linear actuator for automated positioning (legacy model).',
    price: 780.00,
    weight: '3.8 kg',
  ...
  {
    id: 'p6',
    name: 'Coolant Flow Valve',
    sku: 'CFV-2025-001',
    version: '1.0',
    status: 'Active',
    category: 'Fluid Systems',
    description: 'Proportional coolant flow control valve for CNC systems.',
    price: 540.00,
    weight: '2.1 kg',
    material: 'Brass / PTFE Seals',
...
export const boms = [
  {
    id: 'b1',
    name: 'Hydraulic Pump Assembly BoM',
    productId: 'p1',
  ...
  {
    id: 'b2',
    name: 'Electronic Control Unit BoM',
    productId: 'p2',
  ...
  {
    id: 'b3',
    name: 'Precision Gear Box BoM',
    productId: 'p3',
    productName: 'Precision Gear Box',
    version: '1.4',
    status: 'Active',
    components: [
  ...
  {
    id: 'b4',
    name: 'Thermal Sensor Module BoM',
    productId: 'p4',
    productName: 'Thermal Sensor Module',
    version: '1.1',
    status: 'Active',
    components: [
  ...
  {
    id: 'b5',
    name: 'Coolant Flow Valve BoM',
    productId: 'p6',
    productName: 'Coolant Flow Valve',
    version: '1.0',
    status: 'Active',
    components: [
...
export const ecos = [
  {
    id: 'eco1',
    title: 'Upgrade Seal Material for High-Temp Applications',
  ...
  {
    id: 'eco3',
    title: 'Improve Gear Box Bearing Arrangement',
  ...
  {
    id: 'eco4',
    title: 'Update Thermal Sensor Calibration Range',
  ...
  {
    id: 'eco5',
    title: 'Add Pressure Relief to Coolant Valve',
    ecoNumber: 'ECO-2026-005',
    type: 'BoM',
    productId: 'p6',
    productName: 'Coolant Flow Valve',
    bomId: 'b5',
...
export const activityTimeline = [
  { id: 'a1', type: 'eco_created', title: 'ECO-2026-005 Created', description: 'Priya Mehta created ECO for Coolant Flow Valve', timestamp: '2026-03-20 16:30', user: 'Priya Mehta', ecoId: 'eco5' },
  { id: 'a2', type: 'eco_created', title: 'ECO-2026-001 Created', description: 'Rishi Patel created ECO for Hydraulic Pump seal upgrade', timestamp: '2026-03-18 10:15', user: 'Rishi Patel', ecoId: 'eco1' },
  { id: 'a3', type: 'eco_submitted', title: 'ECO-2026-004 Submitted', description: 'Thermal Sensor calibration ECO submitted for review', timestamp: '2026-03-16 11:00', user: 'Rishi Patel', ecoId: 'eco4' },
  { id: 'a4', type: 'eco_approved', title: 'ECO-2026-003 Completed', description: 'Gear Box bearing ECO approved and applied to production', timestamp: '2026-03-15 00:00', user: 'System', ecoId: 'eco3' },
  { id: 'a5', type: 'eco_submitted', title: 'ECO-2026-002 Submitted', description: 'WiFi Module ECO submitted for approval review', timestamp: '2026-03-12 09:30', user: 'Rishi Patel', ecoId: 'eco2' },
  { id: 'a6', type: 'product_updated', title: 'Thermal Sensor Module Updated', description: 'Version 1.1 released with extended calibration', timestamp: '2025-12-01 15:20', user: 'Ananya Sharma', ecoId: null },
  { id: 'a7', type: 'eco_created', title: 'ECO-2025-012 Created', description: 'Hydraulic Pump seal material change initiated', timestamp: '2025-11-18 09:45', user: 'Rishi Patel', ecoId: null },
...
export const notifications = [
  ...
  { id: 'n3', title: 'ECO-2026-003 has been approved', type: 'info', ecoId: 'eco3', read: true, timestamp: '2026-02-24 10:00' },
  { id: 'n4', title: 'ECO-2026-005 created by Priya Mehta', type: 'info', ecoId: 'eco5', read: false, timestamp: '2026-03-20 16:30' },
];
